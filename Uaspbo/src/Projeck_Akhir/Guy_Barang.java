 ...
 * @author ASUS
 */
public class Guy_Barang extends javax.swing.JFrame {

    /**
     * Creates new form Guy_Barang
     */
    public Guy_Barang() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(11, 279, 265, 286);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guy_Barang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Guy_Barang().setVisible(true);
            }
        });
    }
